                    ...
                    _data.delete('checks', checkId, function(err) {
                      ...
                      if (checksDeleted == checksToDelete) {
                        if (!deletionErrors) {
                          ...
                          callback(500, { Error: "Errors encountered when trying to delete the user's checks. All checks may not have been deleted successfully" });
                        }
                      }
                    });
                  });
              ...
              if (!err) {
                ...
                _data.read('users', checkData.userPhone, function(err, userData) {
                  if (!err && userData) {
                    ...
                    callback(500, { Error: "Could not find user who created the check, so couldn't remove from the list of checks" });
                  }
                });
              } else {
