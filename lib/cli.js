...
// Iinstantiate the CLI module object
var cli = {}
...
cli.responders.help = function() {
    ...
    var commands = {
        ...
        'list users': 'Show a list of all ther registered (undeleted) users in the system.',
...
cli.responders.stats = function() {
    ...
    var stats = {
        ...
        'Allocated Heap Used(%)':
            Math.round((v8.getHeapStatistics().used_heap_size / v8.getHeapStatistics().total_heap_size) * 100) + '%',
        'Available Heap Allocated (%)':
            Math.round((v8.getHeapStatistics().total_heap_size / v8.getHeapStatistics().heap_size_limit) * 100) + '%',
...
cli.processInput = function(str) {
    ...
    // Only process the input if the user actually wrote something. Otherwaise, ignore.
    if (str) {
